...
latex_documents = [("index", "django-postgres.tex", u"django\\-postgres Documentation", u"Author", "manual")]
...
man_pages = [("index", "django-postgres", u"django-postgres Documentation", [u"Author"], 1)]
...
texinfo_documents = [
    (
        "index",
        "django-postgres",
        u"django-postgres Documentation",
        u"Author",
        "django-postgres",
